<section class="one-door-section">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <img src="img/doors/oak/<?=$door->img;?>" alt="<?=$door->alias;?>">
            </div>
            <div class="col-md-9">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="add-to-product">
                                <table class="table table-hover">
                                    <tbody>
                                    <tr>
                                        <td>Дверная коробка дуб 75*34*2100 мм. с пазом под добор 2,5 шт.</td>
                                        <td><?=$door->price_korobka;?> руб.</td>
                                    </tr>
                                    <tr>
                                        <td>Наличник дуб 80*12*2200 мм. 5 шт.</td>
                                        <td><?=$door->price_nalich;?> руб.</td>
                                    </tr>
                                    <tr>
                                        <td>Добор дуб 100*16*2200 мм. 2,5 шт.</td>
                                        <td><?=$door->price_dobor;?> руб.</td>
                                    </tr>
                                    <tr>
                                        <td>Карниз дуб ( для двери 400/600/700/800 и 900 мм.) 1 шт.</td>
                                        <td><?=$door->price_karniz;?> руб.</td>
                                    </tr>
                                    <tr>
                                        <td>Сапожок дуб 90*200 мм. 1шт.</td>
                                        <td><?=$door->price_sapog;?> руб.</td>
                                    </tr>
                                    <tr>
                                        <td>Розетка дуб 90*90 мм. 1шт.</td>
